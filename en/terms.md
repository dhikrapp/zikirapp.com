...
By using the Zikir App ("Service"), you are agreeing to be bound by the following terms and conditions ("Terms of Service").

Zikir App, LLC ("Company") reserves the right to update and change these Terms of Service without notice.
...
4. The look and feel of the Service is copyright© 
, LLC. All rights reserved. You may not duplicate, copy, or reuse any portion of the HTML, CSS, JavaScript, or visual design elements without express written permission from the Company.
...
14. Questions about the Terms of Service should be sent to [support@zikirapp.com](mailto:support@zikirapp.com).
